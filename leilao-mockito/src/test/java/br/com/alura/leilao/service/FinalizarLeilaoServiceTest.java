...
class FinalizarLeilaoServiceTest {
	...
	@Test
	void NaoDeveriaEnviarEmailParaVencedorEmCasoDeErroDoLeilao() {
		List<Leilao> leiloes = leiloes();
		Mockito.when(leilaoDao.buscarLeiloesExpirados()).thenReturn(leiloes);
	...
	private List<Leilao> leiloes() {
		...
		Lance primeiro = new Lance(new Usuario("Lia"), new BigDecimal("600"));
		Lance segundo = new Lance(new Usuario("Nathy"), new BigDecimal("900"));
